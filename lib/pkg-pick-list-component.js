...
export default class PkgPickList {
  ...
  move (direction, item) {
    ...
    const [fromList, newFrom] = direction === 'right'
      ? [this.leftList, newProps.leftList]
      : [this.rightList, this.props.rightList]
    const [toList, newTo] = direction === 'right'
      ? [this.rightList, this.props.rightList]
      : [this.leftList, this.props.leftList]
