...
/** a list of expected properties so we can pass-through others */
const PKG_SELECT_LIST_PROPS = new Immutable.Set([
  'emptyMessage',
  'errorMessage',
  'infoMessage',
  'loadingMessage',
  'loadingBadge',
  'skipCommandsRegistration',
  'selectableItems',
  'index',
  'className',
  'items',
...
export default class PkgSelectList {
  ...
  constructor (props = {
    ...
    this.props = {}
    /** a list of expected properties so we can pass-through others */
    this.knownProperties = PKG_SELECT_LIST_PROPS
  ...
  _setProps (props) {
    ...
    this.props.className = addIfMissing('select-list pkg-select-list', props.className, ' ')
    this.props.otherProps = {}
    for (const prop in props) {
      if (!this.knownProperties.has(prop)) {
        this.props.otherProps[prop] = String(props[prop])
      }
    }
  }
  ...
  render = () => <div className={this.props.className} {...this.props.otherProps}>
