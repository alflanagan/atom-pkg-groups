...
export default {
  ...
  deserializePkgGroupsView (serialized) {
    if (!(serialized.hasOwnProperty('props') && serialized.hasOwnProperty('children'))) {
      throw new Error('deserializePkgGroupsView param missing required properties')
    }
    this.view = new PkgGroupsView(serialized.props, serialized.children)
    return this.view
  }
}
